...
public class FigurativeConstantMap {
    ...
    public String map(String figurativeConstant) {
        ...
        else if ("ALLSPACES".equals(figurativeConstant)) return " ";
        ...
        else if ("NULL".equals(figurativeConstant) || "NULLS".equals(figurativeConstant)) return "";
        ...
        LOGGER.warning("Unsupported figurative constant: " + figurativeConstant + ", defaulting to empty string");
        return "";
    }
}
