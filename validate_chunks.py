...
VALID_COBOL_CHUNK_TYPES = {
    ...
    "controlflow.cfg", "dataflow.variable", "business_rule",
    "call_contract", "error_path", "screen.pagination", "screen.selection",
    "screen.row_build", "screen.key_dispatch",
    "cics.operation", "cics.program_transfer", "cics.resource", "cics.error_handler",
